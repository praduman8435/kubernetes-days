...
> 
> <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727034930881/8c184bd2-5f7c-4c36-80e9-53203a40394f.png">
  </p>
...
* To see the pod’s IP
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727035501759/932c5c16-6dd0-4461-9f7b-ebab8a292092.png">
  </p>
...
* Check the node where the pod is running and SSH into it
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727035555351/cb03278f-88d1-40a7-a2c7-587560689130.png">
  </p>
...
* To view the network namespaces created
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727035604459/eb73248a-0f9f-4c19-906f-df4b22663d57.png">
  </p>
...
* To find the pause container
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727035736678/89d8c4ba-3b5f-45c2-8bac-ad312301a9f4.png">
  </p>
...
* Get details of the pause container's namespaces (net, ipc, uts)
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727036619786/dd3809c1-6b17-4746-8468-ce630f4354e0.png">
  </p>
...
* To check the list of all network namespaces
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727035836018/33ba65eb-bb9f-4eb4-8ff7-daba9e073298.png">
  </p>
...
* Exec into the namespace or into the pod to see the ip link
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727036968501/178cacd3-2285-4703-8e87-13c85fa98293.png">
  </p>
...
* **Inter Node communication**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727037359729/dcb73739-2675-44f4-bb1a-b9edafb5b36b.png">
  </p>
...
<p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727037799205/fa47b17e-b08e-4357-bb56-fbef2aefbaac.png">
</p>
...
* **Create a StatefulSet**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909024059/d8691034-3b8f-4fdd-81ee-2ce4c0f3e793.png">
  </p>
...
* **A** `persistent volume` **and** `persistent volume claim` **is also created**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909331546/a1451085-b5ec-4629-8235-d3303b68232d.png">
  </p>
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909335672/57582e0d-5be9-4c19-a719-7cdb17f650ca.png">
  </p>
    
* **Check for pods that is created**
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909533722/5aa3f5db-9348-4eb3-8fc5-88f1b48bdaa0.png">
  </p>
...
* **Create a service (**`svc.yml`**)**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909682007/e8931793-58ac-4451-a44e-1d351bab5bf6.png">
  </p>
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726909735841/b07da77b-02b0-4565-bbb6-c9152bb2f547.png">
  </p>
...
* **Increase the replicas and you will see the each pod have a ordered and fixed name**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726910106467/347b2175-fc31-485a-be0d-9f7247065427.png">
  </p>
...
* **If you delete a pod a new pod with the same name again created**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1726910233816/886c15f4-3136-4b00-84f6-3a39e65c5fcb.png">
  </p>
...
<p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727105140410/67d640fd-661b-4317-92a9-efbf90edf1ce.png">
</p>

**Access the Server** `http://192.168.1.4:32613`

<p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727106216440/f2329250-44eb-4cd9-bfd7-fb0f112c25ad.png">
</p>
...
* **Check NodePort and KUBE Rules**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727106551462/6aff24b2-d087-4c72-bea0-7792b271cd4e.png">
  </p>
...
* **Check Specific NodePort Rules**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727106679408/43bfcd1c-f643-48d9-a327-ca797995c469.png">
</p>
...
* **Creating a LoadBalancer service in minikube**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727110315954/0c508165-b196-45cb-9bbb-63878ab5d84b.png">
  </p>
...
* **Creates a network tunnel, making your LoadBalancer service accessible**
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727110572203/cd3f2ba4-6407-4359-ab56-fae09ddd2438.png">
  </p>
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727110594870/e60f4c85-1994-427f-b561-8e461773bcc8.png">
  </p>
    
* **Access the Service at** `External-ip`
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727110670807/563b2536-c0f8-4aa7-b79b-3dab581c0531.png">
  </p>
...
* Create the database pod and service
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727115368577/3a5fc1d0-0a0b-491e-9e2e-0a64fd83ca0b.png">
  </p>
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727115377815/cfdda7e6-a74b-4410-aa5b-ae1f0ac27e63.png">
  </p>
...
* Create ExternalName service
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727115300028/65f8c022-4f09-4066-bb27-fe42011993bd.pn">
  </p>
...
* Create the pod
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727115974019/eccd8060-429f-4b69-9f92-f894b4c205fb.png">
  </p>
...
* Access the server
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727124231790/d638df6e-1f6e-4d01-9356-25a8f724fb9e.png">
  </p>
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727124365615/d06b9753-85f6-401b-b263-1fbcfa5c948c.png">
  </p>
...
* ssh onto the node where the pod is deployed and the change the /etc/hosts file
    ...
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727125797335/802cb4be-a2a6-4caa-bb42-15cb1b0c93e2.png">
  </p>
    
    <p align="center">
  <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1727125853427/5a725d7c-30cd-40cf-94a6-aac359eb74fa.png">
  </p>
